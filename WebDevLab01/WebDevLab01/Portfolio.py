...
def links_section():
    ...
    pawmates_link= f'<a href="{info.my_pawmates_url}"><img src="{info.linkedin_image_url}" alt="PawMates" width= "75" height="75"></a>'
...
education_section(info.education_data,info.)

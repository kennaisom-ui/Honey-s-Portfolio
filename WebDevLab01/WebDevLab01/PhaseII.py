...
#MULTIPLE CHOICE (using new functions) 
...
def calc_scores(q1, q2, q3, q4, q5):
    # Reset scores
    st.session_state.score = {breed: 0 for breed in st.session_state.score}
...
def results():
    ...
    # DOG IMAGE URLS
    image_urls = {
        "Mutt": "https://i.postimg.cc/0b6ksTZY/mutt.jpg",
        "Poodle/Doodle": "https://i.postimg.cc/JD68wxk9/poodle.jpg",
        "Golden Retriever": "https://i.postimg.cc/Btz3MhsH/golden.jpg",
        "Husky": "https://i.postimg.cc/gwGbnQyR/husky.jpg",
        "Beagle": "https://i.postimg.cc/Q9tLq7yF/beagle.jpg",
        "Daschund": "https://i.postimg.cc/ZvB1GSZt/daschund.jpg",
        "Bulldog": "https://i.postimg.cc/yW2qFkX0/bulldog.jpg",
        "AN IMPOSTER!...YOU'RE A CAT!": "https://i.postimg.cc/dhKzxpf7/cat.jpg"
    }
    
    if your_breed in image_urls:
        st.image(image_urls[your_breed], width=300)
    else:
        st.write("No image available for your result.")
